...
for gz in gz_list:
	...
	_command='7z.exe x '+tar_name+' -o'+_temp_dir+' *B10*'
	print _command
	os.system(_command)
	_command='7z.exe x '+tar_name+' -o'+_temp_dir+' *B11*'
	os.system(_command)
	tif_list=list()
	...
	arcpy.CompositeBands_management(tif_list[0]+';'+tif_list[1], scene_name_tif)
